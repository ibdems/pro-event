...
# Lengo Pay (remplace Paycard)
LENGOPAY_API_BASE_URL = env("LENGOPAY_API_BASE_URL", default="https://sandbox.lengopay.com")
LENGOPAY_WEBSITE_ID = env("LENGOPAY_WEBSITE_ID", default="HNJUtRjj3zavbRva")
LENGOPAY_LICENSE_KEY = env(
    "LENGOPAY_LICENSE_KEY",
    default="MHlOR20xU2FuU2szQ1Y5VXlJc1hYZjRuYVNxN2szM0xlMFVCMk9RaHF5bGlOcGN2ejY3bHNOWUVnbjZrMjhNbw==",
)
